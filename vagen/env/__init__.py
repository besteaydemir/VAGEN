...
from .video import RoomEnv, RoomEnvConfig, RoomService, RoomServiceConfig
...
REGISTERED_ENV = {
    ...
    "room_exploration": {
        "env_cls": RoomEnv,
        "config_cls": RoomEnvConfig,
        "service_cls": RoomService,
        "service_config_cls": RoomServiceConfig
    }
}
